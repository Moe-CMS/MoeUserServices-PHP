...
$lang = [
    'Jump Prompt' => '跳转提示',
'The page will jump automatically in' => '页面将会在',
'seconds' => '秒后跳转',
'Back to previous page' => '返回上页',
'Jump Now' => '现在跳转'
];
...
$langSet = $langSet && in_array($langSet, ['zh-cn', 'en-us']) ? $langSet : 'zh-cn';
$langSet == 'en-us' && $lang = array_combine(array_keys($lang), array_keys($lang));
?>
...
?>
    <div class="system-message {$codeText}">
        ...
        <p class="jump">
            <?=$lang['The page will jump automatically in']?> <span id="wait"><?php echo($wait);?></span> <?=$lang['seconds']?>
        </p>
        <p class="clearfix">
            <a href="#" onClick="javascript :history.back(-1);" class="btn btn-grey"><?=$lang['Back to previous page']?></a>
